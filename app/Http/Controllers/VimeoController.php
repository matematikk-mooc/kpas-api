...
{
    private function isAutoGenerated(string $language): bool
    {
        return str_contains(strtolower($language), '-x-autogen');
    }
    ...
    public function index(int $vimeoId)
    {
        ...
        foreach($subtitles as $subtitle) {
            ...
            if ($this->isAutoGenerated($subtitleLanguage)) {
                if($vimeoId !== $pingVimeoId) logger("VimeoController::index vimeo_id=" . $vimeoId . " skipping auto-generated subtitle_language=" . $subtitleLanguage);
                continue;
            }
