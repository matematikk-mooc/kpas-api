{
    "title": "Rolle og grupper - Leder ({{ getenv "CANVAS_ACCESS_KEY_NAME" }})",
    "description": "Rolle og grupper - Leder ({{ getenv "CANVAS_ACCESS_KEY_NAME" }})",
                ...
                "placements": [
                    {
                        ...
                        "target_link_uri": "{{ getenv "APP_URL" }}/launch?config_directory=configs",
                        "text": "Rolle og grupper - Leder ({{ getenv "CANVAS_ACCESS_KEY_NAME" }})",
                        "selection_width": 800,
    ...
    "custom_fields": {
        ...
        "institution_leader_description": "Skoleeier",
        ...
        "institution_participant_description": "Skoleleder"
    },
