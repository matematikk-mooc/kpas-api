{
    "title": "Brukersammenslåing ({{ getenv "CANVAS_ACCESS_KEY_NAME" }} - Global)",
    "description": "Brukersammenslåing ({{ getenv "CANVAS_ACCESS_KEY_NAME" }} - Global)",
                ...
                "placements": [
                    {
                        ...
                        "target_link_uri": "{{ getenv "APP_URL" }}/launch?config_directory=configs",
                        "text": "Brukersammenslåing ({{ getenv "CANVAS_ACCESS_KEY_NAME" }} - Global)",
                        "selection_width": 800,
    ...
    "custom_fields": {
        "kpas_user_view": "user_management",
